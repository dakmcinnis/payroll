...
class TimesheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post timesheets_url, params: { timesheet: { pay_period_id: @timesheet.pay_period_id, user_id: @timesheet.user_id } }
  #   end
  ...
  #   patch timesheet_url(@timesheet), params: { timesheet: { pay_period_id: @timesheet.pay_period_id, user_id: @timesheet.user_id } }
